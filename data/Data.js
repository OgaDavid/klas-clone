...
export const Features_one = [
  {
    ...
    text: {
      ...
      list: [
        "Engage in new ways with polls, emojis, Q+A",
        "One-click recordings & cloud storage",
  ...
  },
  {
    ...
    text: {
      ...
      list: [
        "Instant booking with Klas pay",
        "Fast payouts in different currencies",
...
export const Features_two = [
  {
    name: "manage",
    text: {
      heading: "Manage your classes",
      list: [
        "Track your enrollments and earnings from one place",
        "In-depth student insights to help run your academy",
  ...
  },
  {
    name: "engage",
    text: {
      heading: "Engage your learners",
      list: [
        "Create cohorts to help leaners share ideas and get feedback",
        "Direct messages and group chats with ease",
...
export const Features_three = [
  {
    name: "teamwork",
    text: {
      heading: "Built for Teamwork",
      list: [
        "Invite unlimited instructors, assign roles",
        "Add instructors to classes",
...
export const ProductsCardData = [
  {
    ...
    img: "images/productspage/bootcamps.png",
  },
  {
    name: "Fellowship",
    img: "images/productspage/fellowship.png",
  },
  {
    name: "Workshops",
    img: "images/productspage/workshops.png",
  },
  {
    name: "Webinars",
    img: "images/productspage/webinars.png",
  },
  {
    name: "Coaching",
    img: "images/productspage/coaching.png",
  },
  {
